...
/**
 * Login_controller zajišťuje tvorbu formulářů k loginu i registraci
 * a následnému zpracování těchto formulářů
 *
...
class Login_controller extends CI_Controller {
    ...
    function loginFinish() {
        ...
        if ($return) {
            // login ok => přesměrování do administrace
    ...
    function register() {
        ...
        $data["main"] = "frontend/registerPage";
        $this->layout->generate($data);
    }
