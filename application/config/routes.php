...
*/
$route['default_controller'] = 'Hlavni_controller/index';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;

$route['index'] = 'Hlavni_controller/index';
$route['mapa'] = 'Hlavni_controller/mapa';

$route['login'] = 'Login_controller/login';
$route['login-finish'] = 'Login_controller/loginFinish';
$route['register'] = 'Login_controller/register';
$route['register-finish'] = 'Login_controller/registerFinish';

$route['admin'] = 'Dashboard_controller/dashboard';
